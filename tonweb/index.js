...
const init = async () => {
    ...
    const seedA = TonWeb.utils.base64ToBytes(secretKeyA); // A's private (secret) key
    const keyPairA = tonweb.utils.keyPairFromSeed(secretKeyB); // Obtain key pair (public key and private key)
